...
public class AutoUpdateService extends Service {
	...
	public int onStartCommand(Intent intent, int flags, int startId) {
		...
		manager.set(AlarmManager.ELAPSED_REALTIME_WAKEUP, trigglerAtTime, pi);
	...
	private void updateWeather(){
		...
		String weather = prefs.getString("weather_code", "");
		String address = "http://www.weather.com.cn/data/cityinfo/" + weather + ".html";
